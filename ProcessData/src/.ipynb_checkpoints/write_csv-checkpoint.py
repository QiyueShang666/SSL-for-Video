...
def main_UCF101(f_root, splits_root, csv_root='../data/ucf101/'):
    ...
    for which_split in [1,2,3]:
        ...
        with open(train_split_file, 'r') as f:
            for line in f:
                vpath = os.path.join(f_root, line.split('.')[0]) + '/'
                # print(f_root)
                print(vpath)
...
if __name__ == '__main__':
    ...
    main_UCF101(f_root='/root/autodl-tmp/frame/',
                splits_root='/root/autodl-tmp/splits_classification')

    # main_HMDB51(f_root='D:/VideoData/HMDB51/frame',
    #             splits_root='D:/VideoData/HMDB51/testTrainMulti_7030_splits')
